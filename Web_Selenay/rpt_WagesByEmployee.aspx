    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:com_PMTP %>" SelectCommand="SELECT tbl_EmployeeWages.Wage_ID, tbl_EmployeeWages.Wage_Amount, tbl_EmployeeWages.Wage_Commision, tbl_EmployeeWages.Wage_Total, tbl_EmployeeWages.Wage_Year, tbl_Lookups.Month FROM tbl_EmployeeWages INNER JOIN tbl_Lookups ON tbl_EmployeeWages.Month_ID = tbl_Lookups.LK_ID WHERE (tbl_EmployeeWages.Empl_Id = @Empl_Id)">
                        <SelectParameters>
